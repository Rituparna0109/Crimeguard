...
def insertData(data):
    ...
    db =pymysql.connect(host="localhost", user="root",password= "fastnfury1@2",database= "criminal",charset='utf8mb4',cursorclass=pymysql.cursors.DictCursor)
    cursor = db.cursor()
...
def retrieveData(name):
    ...
    db = pymysql.connect(host="localhost", user="root",password= "fastnfury1@2",database= "criminalrecord")
    cursor = db.cursor()
    print("database connected")

    query = "SELECT * FROM criminaldat WHERE name='%s'"%name
